...
calculation_modes = {
    0: "Последовательно",
    1: "Параллелизация внешнего цикла",
    2: "Параллельное вычисление значений, static schedule",
    3: "Параллельное вычисление значений, dynamic schedule",
    4: "Параллельное вычисление значений, guided schedule",
}
...
def benchmark_matrix(matrix_shape=()):
    print(f"Benchmarking matrix of size {matrix_shape[0]}x{matrix_shape[1]} * "
